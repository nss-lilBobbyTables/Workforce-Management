...
namespace WorkforceManagement.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Description,Name,Type")] Departments departments)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Description,Name,Type")] Departments departments)
        {
            if (ModelState.IsValid)
            {
